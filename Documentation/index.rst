...
.. describe:: Distro
   ...
   unpredictable. Currently supported distros are Ubuntu 22.04, Debian 12, CentOS
   Stream 9, Red Hat Universal Base Image (UBI) 9, Red Hat Universal Base Image
   (UBI) 9 minimal and SUSE Linux Enterprise Server 15.
